...
if (typeof window !== "undefined") {
  ...
  if (typeof AudioWorkletNode !== 'function' || !('audioWorklet' in AudioContext.prototype)) {
    if (AudioContext) {
      ...
      window.AudioWorkletNode = window.AudioWorkletNode || function (context, processorName, options) {
  ...
  _createClass$1(WebVoiceProcessor, [{
    ...
    value: function () {
      var _setupRecorder = _asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(options) {
        var _options$outputSample, outputSampleRate, _options$frameLength, frameLength, _options$deviceId, deviceId, _options$filterOrder, filterOrder, _options$audioConstra, audioConstraints, numberOfChannels, audioContext, microphoneStream, audioSource, resamplerWorker, recorderNode;
